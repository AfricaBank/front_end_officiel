import {Table, Thead, Input, Tbody, Tr, Th, Td, Box, IconButton, Flex} from "@chakra-ui/react";
            ...
            <Box>
                ...
                <Box mb={4}>
                    <Input
                        ...
                        mr={2}
                    />
                    {/*<Button colorScheme="teal" onClick={handleFilterClick} mr={2}>
                        Filtrer
                    </Button>
        ...
        <Table variant="simple">
            <Thead>
                <Tr width="1732.38px"
                    ...
                    left="123.31px"
                    borderRadius="10px"
                    bg={colors.primary.doggerBlue[500]}>
                        ...
                        <Td>
                            <Flex>
                                ...
                                <IconButton
                                    ...
                                    icon={<icons.icon27 fontSize="30px" paddingTop={2.5} paddingLeft={2.5}/>}
                                    //onClick={() => handleEdit(item)}
                                    mr={2}
                                />
                                <IconButton
                                    ...
                                    colorScheme='red'
                                    size='sm'
                                    icon={<icons.icon26 fontSize="30px" paddingTop={2.5} paddingLeft={2.5}/>}
